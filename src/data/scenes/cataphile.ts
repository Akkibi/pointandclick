    ...
    conversations: [
        {
            ...
            dialog: {
                start: {
                    lines: {
                        0: ["Oi! You! What the hell are you doing down here without a light?"],
                    },
                    options: [
                ...
                "What Happened?": {
                    ...
                    options: [{ text: "Tunnels? What do you mean?", destination: "Where am I?" }],
                },
                "Who are you?": {
                    lines: {
                        0: ["Hold on, that's what I want to know, who are you?"],
                    },
                    options: [{ text: "I... don't remember", destination: "I... don't remember" }],
                },
                "I... don't remember": {
                    lines: {
                        0: [
                    ...
                    options: [{ text: "Am I dead?", destination: "Am I dead?" }],
                },
                "Am I dead?": {
                    lines: {
                        0: ["What? No."],
                    ...
                    options: [
                        {
                            text: "But... I just jumped off of a building",
                            destination: "But... I just jumped off of a building",
                        },
                    ],
                },
                    ...
                    options: [
                        {
                            ...
                            destination: "What the hell is going on?",
                        },
                    ],
                },
                "What the hell is going on?": {
                    lines: {
                        0: ["I think you're in-between"],
                    },
                    options: [
                        {
                            text: "In-between? What do you mean?",
                            destination: "In-between? What do you mean?",
                        },
                    ],
                },
                "In-between? What do you mean?": {
                    ...
                    options: [
                        {
                            text: "It's not what I wanted to happen. I just want to disappear",
                            destination:
                ...
                "It's not what I wanted to happen. I just want to disappear": {
                    ...
                    options: [
                        {
                            text: "This is bullshit, I can't stay here",
                            destination: "This is bullshit, I can't stay here",
                        },
                        {
                            text: "Something else? Like what?",
                            destination: "Something else? Like what?",
                        },
                    ],
                },
                "This is bullshit, I can't stay here": {
                    lines: {
                        0: ["Well as I see it, for you there's probably only one way out."],
                    },
                    options: [{ text: "What is it?", destination: "What is it?" }],
                },
                ...
                "What is it?": {
                    ...
                    options: [{ text: "Lutetia?", destination: "Lutetia?" }],
                },
                "Lutetia?": {
                    lines: {
                        0: [
                ...
                "How can you be certain?": {
                    ...
                    options: [
                        {
                            text: "Do you really think it will help me?",
                            destination: "Do you really think it will help me?",
                        },
                ...
                "How do I get there?": {
                    ...
                    options: [{ text: "Sounds promising...", destination: "Sounds promising..." }],
                },
                "What do you mean?": {
                    lines: {
                        0: [
                ...
                "Sounds promising...": {
                    ...
                    options: [
                        {
                            text: "I don't really have a choice do I?",
                            destination: "I don't really have a choice do I?",
                        },
                        {
                            text: "I hope I will see what you mean",
                            destination: "I hope I will see what you mean",
                        },
                        {
                            text: "I don't know. I think I'll just find my own way",
                            destination: "I don't know. I think I'll just find my own way",
                        },
                    ],
                },
