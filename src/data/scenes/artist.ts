  ...
  conversations: [
    {
      ...
      dialog: {
        start: {
          lines: {
            0: [
              "No, that’s not right... maybe another line here... or... There?",
            ],
          },
          options: [
            { text: "Uhm... Hello?", destination: "Uhm... Hello?" },
            { text: "...Is all of this yours?", destination: "...Is all of this yours?" },
            { text: "You’ve been staring at this for a while, haven’t you?", destination: "Uhm... Hello?" },
          ],
        },
        "Uhm... Hello?": {
          lines: {
          ...
          options: [
            { text: "I know a thing or two about being lost", destination: "I don’t think I’ve made anything in a long time." },
            { text: "...Is all of this yours?", destination: "...Is all of this yours?" },
          ],
        },
        "...Is all of this yours?": {
          ...
          options: [
            ...
            { text: "I don’t think I’ve made anything in a long time.", destination: "I don’t think I’ve made anything in a long time." },
        ...
        "You don't seem tired": {
          ...
          options: [
            { text: "How do you make it go away?", destination: "It just feels heavier now." },
            { text: "I just wanted everything to stop.", destination: "It just feels heavier now." },
          ],
        },
        ...
        "Looks unfinished.": {
          ...
          options: [
            ...
            { text: "It’s quiet. Not sad, not happy. Just... still.", destination: "It’s quiet. Not sad, not happy. Just... still." },
            { text: "Honestly, I don’t feel anything when I look at it.", destination: "Honestly, I don’t feel anything when I look at it." },
          ],
        },
        "It looks melancolic": {
          lines: {
          ...
          options: [
            { text: "I guess I have been walking around for a while now...", destination: "I don't really remember what I'm looking for." },
            { text: "I just want it to stop... so I'm looking for something... A place called Lutetia", destination: "I am looking for something... A place called Lutetia" },
          ],
        },
        "It’s quiet. Not sad, not happy. Just... still.": {
          ...
          options: [
            { text: "I guess I have been walking around for a while now...", destination: "I don't really remember what I'm looking for." },
            { text: "I don't really remember what I'm looking for.", destination: "I don't really remember what I'm looking for." },
            { text: "I'm looking for something... A place called Lutetia", destination: "I am looking for something... A place called Lutetia" },
          ],
        },
        ...
        "I don't really remember what I'm looking for.": {
          lines: {
            0: [
              "I think you know what you're looking for.",
            ],
          },
          options: [
            { text: "Lutetia?", destination: "I am looking for something... A place called Lutetia" },
          ],
        },
        "I am looking for something... A place called Lutetia": {
          ...
          options: [
            { text: "Wait... You've been there??", destination: "Wait... You've been there??" },
        ...
        "Wait... You've been there??": {
          lines: {
            0: [
              "Yes. Finding that place changed everything.",
            ],
          },
          options: [
        ...
        "So it’s real?!": {
          lines: {
            0: [
              "It’s real enough. Finding that place changed everything.",
            ],
          },
          options: [
            { text: "What was it like?", destination: "What was it like?" },
        ...
        "What do you mean?": {
          ...
          options: [
            { text: "So you're painting took you to Lutetia...", destination: "So you're painting took you to Lutetia..." },
            { text: "This all sounds pretty hard to believe...", destination: "This all sounds pretty hard to believe..." },
          ],
        },
        "So you're painting took you to Lutetia...": {
          ...
          options: [
            { text: "Ok. I think I know what I have to do", destination: null },
          ],
        },
        ...
        "It just feels heavier now.": {
          ...
          options: [
            ...
            { text: "Nothing. It’s just paint on rocks.", destination: "Something's missing." },
            { text: "Calm? Or maybe surrender. I can’t tell.", destination: "Something's missing." },
          ],
        },
        "Something's missing.": {
          lines: {
            0: [
              "That makes sense. Most people see their own silence in it.",
            ],
          },
          options: [
            { text: "I am looking for something... A place called Lutetia", destination: null },
          ],
        },
      },
    },
