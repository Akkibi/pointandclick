  ...
  conversations: [
    {
      ...
      dialog: {
        start: {
          lines: {
            0: [
              "Ahh! Joe! You're back! Just in time, I'm almost out of snacks."
            ]
          },
          options: [
        ...
        "What?!": {
          ...
          options: [
            { text: "Yeah... you don't look so good.", destination: "Yeah... you don't look so good." },
        ...
        "Great. A crazy old man.": {
          ...
          options: [
            { text: "I don't have time for soup. I have to get out of here!", destination: "I don't have time for soup. I have to get out of here!" }
          ]
        },
        "Who's Joe?": {
          lines: {
          ...
          options: [
            { text: "Wait a second, you live down here?", destination: "Wait a second, you live down here?" }
          ]
        },
        ...
        "Wait a second, you live down here?": {
          lines: {
            0: [
              "Well. Yes! Pretty sweet deal wouldn't you say?"
            ]
          },
          options: [
            { text: "You're insane", destination: "Great. A crazy old man." },
            { text: "How long have you been down here??", destination: "Wait. What do you mean a long time." }
          ]
        },
        "I don't have time for soup. I have to get out of here!": {
          ...
          options: [
            { text: "Wait. What do you mean a long time.", destination: "Wait. What do you mean a long time." }
          ]
        },
        ...
        "25 Years???": {
          ...
          options: [
            { text: "Don't you miss the light? The people? Real life?", destination: "Don't you miss the light? The people? Real life?" },
        ...
        "Don't you miss the light? The people? Real life?": {
          ...
          options: [
            ...
            { text: "I guess in a way I see what you mean", destination: "I guess in a way I see what you mean" }
          ]
        },
        "It was... Romantic?": {
          lines: {
        ...
        "That's incredibly sad": {
          ...
          options: [
            { text: "Do you really feel less lonely here?", destination: "Do you really feel less lonely here?" }
          ]
        },
        ...
        "Do you really feel less lonely here?": {
          ...
          options: [
            { text: "Like what? What do they say?", destination: "Like what? What do they say?" },
            { text: "The stones... Speak to you?", destination: "The stones... Speak to you?" },
        ...
        "Ok... So?": {
          ...
          options: [
            { text: "What are you getting at?", destination: "What are you getting at?" }
          ]
        },
        "What are you getting at?": {
          ...
          options: [
            { text: "Until what?", destination: "Until what?" }
          ]
        },
        "Until what?": {
          lines: {
          ...
          options: [
            { text: "Yes... I think I understand", destination: "Yes... I think I understand" },
        ...
        "Did you say... Lutetia?": {
          lines: {
            0: [
              "Yes! The old Roman name for Paris. Why do you ask?"
            ]
          },
          options: [
            { text: "That's where I have to go! Do you know how to get there?", destination: "That's where I have to go! Do you know how to get there?" }
          ]
        },
        "That's where I have to go! Do you know how to get there?": {
          ...
          options: [
            { text: "But... It's supposed to be my way out", destination: "But... It's supposed to be my way out" }
          ]
        },
        "But... It's supposed to be my way out": {
          ...
          options: [
            ...
            { text: "Am I really stuck here forever?", destination: "No. That can't be true" }
          ]
        },
        "No. That can't be true": {
          ...
          options: [
            { text: "I guess it was more of a nickname...", destination: "I guess I'll keep looking then" },
            { text: "No that doesn't sound right...", destination: "I guess I'll keep looking then" }
          ]
        },
        "I guess I'll keep looking then": {
          ...
          options: [
            ...
            { text: "There are still some beautiful things that I want to see up there", destination: "It's not all bad" },
            { text: "Yeah... I'll take my time", destination: "Yeah... I'll take my time" }
          ]
        },
        "It's not all bad": {
          lines: {
